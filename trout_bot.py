...
#os.environ[STOCKFISH_ENV_VAR] = "stockfish/Mac/stockfish-10-64"
os.environ[STOCKFISH_ENV_VAR] = "stockfish-10-win/Windows/stockfish_10_x64.exe"
...
class TroutBot(Player):
    ...
    def choose_move(self, move_actions, seconds_left):
        ...
        try:
            ...
            self.invalid_last_move = False
            return result.move
        except (chess.engine.EngineError, chess.engine.EngineTerminatedError) as e:
            self.invalid_last_move = True
